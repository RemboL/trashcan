package pl.rembol.jme3.example;
 ...
 */
public class Hello06Material extends SimpleApplication {

	public static void main(String[] args) {
		Hello06Material app = new Hello06Material();
		app.start();
	}
