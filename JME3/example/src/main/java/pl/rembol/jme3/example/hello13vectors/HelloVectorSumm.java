package pl.rembol.jme3.example.hello13vectors;
...
import pl.rembol.jme3.example.hello13vectors.Debug;
import pl.rembol.jme3.example.hello13vectors.MaterialUtils;
import pl.rembol.jme3.example.hello13vectors.SpatialUtils;
...
public class HelloVectorSumm extends SimpleApplication {
	...
	public void simpleInitApp() {
		...
		Debug.attachWireFrameDebugGrid(assetManager, rootNode, Vector3f.ZERO,
				256, ColorRGBA.DarkGray);

		//
		Box box = new Box(1, 1, 1);
		//
		Material mat = MaterialUtils.makeMaterial(assetManager,
				"Common/MatDefs/Misc/Unshaded.j3md", ColorRGBA.Blue);
		Geometry geom = SpatialUtils.makeGeometry(vctrNodeSpatLoc, scale, box,
				mat, "box");
		...
		Debug.showVector3fArrow(assetManager, rootNode, vctrNodeLoc,
				ColorRGBA.Red, "vctrNodeLoc");
		Debug.showVector3fArrow(assetManager, vctrNode, vctrNodeSpatLoc,
				ColorRGBA.Green, "vctrNodeSpatLoc");
		Debug.showVector3fArrow(assetManager, rootNode, vctrSumm,
				ColorRGBA.Blue, "vctrSumm");
		//
